...
from django.views.decorators.csrf import csrf_exempt  # opcional solo para pruebas

@csrf_exempt  # solo si sospechas que hay problemas con CSRF (puedes quitar esto si usas {% csrf_token %})
